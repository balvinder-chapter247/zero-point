              ...
              <div className="contact_info">
                ...
                <div className="contact_social mt-6">
                  ...
                  <div className="flex items-center mt-2">
                    <Link to={SocialPageLink.facebook} className="social-link fb">
                      <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fab"
                    ...
                    <Link to={SocialPageLink.twitter} className="social-link twitter">
                      <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fab"
                    ...
                    <Link to={SocialPageLink.instagram} className="social-link insta">
                      <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fab"
                    ...
                    <Link to={SocialPageLink.linkedin} className="social-link linkedin">
                      <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fab"
