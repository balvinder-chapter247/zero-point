          ...
          <div className="grid md:grid-cols-4 gap-4">

                {
                    ...
                    <div className="single_features_box">
                        <div className="icon">
                            <img src={data.courseBlackIcon} alt="" className="black_icon" />
                        ...
                        <div className="">
                            <Link to={data.courseLink} className="start-btn">Start Now!</Link>
                        </div>
                    </div>
                    )
                }
                            ...
                            <div className="slider_content">
                                ...
                                <div className="contact_social mt-2">
                                    <div className="flex items-center mt-2">
                                        <a href={data.advisorFacebook} className="social-link fb">
                                        <svg
                                            aria-hidden="true"
                                            focusable="false"
                                            data-prefix="fab"
                                        ...
                                        <a href={data.advisorTwitter} className="social-link twitter">
                                        <svg
                                            aria-hidden="true"
                                            focusable="false"
                                            data-prefix="fab"
                                        ...
                                        <a href={data.advisorInsta} className="social-link insta">
                                        <svg
                                            aria-hidden="true"
                                            focusable="false"
                                            data-prefix="fab"
                                        ...
                                        <a href={data.advisorLinkedin} className="social-link linkedin">
                                        <svg
                                            aria-hidden="true"
                                            focusable="false"
                                            data-prefix="fab"
