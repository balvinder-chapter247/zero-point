          ...
          <div className=""></div>
            <div className="col-span-2">
                <div class="common_heading text-center">
                    <h2 class="font-bold mb-3">Affordable Online Courses and Learning Opportunities</h2>
                    <p>
          ...
          <div className="grid md:grid-cols-4 gap-4">
              <div className="single_features_box">
                  ...
                  <div className="content">
                      <h5>Learn the Latest Top Skills</h5>
                      <p>
                      Learning top skills can bring an extra-ordinary outcome in a career.
                      </p>
                  </div>
                  <div className="">
                    <Link to="#" className="start-btn">Start Now!</Link>
                  </div>
              </div>
              <div className="single_features_box">
                  <div className="icon">
              ...
              <div className="single_features_box">
                  ...
                  <div className="content">
                      <h5>Enjoy Learning From Anywhere</h5>
                      <p>
      ...
      <section className="sec-padding testimonial_sec">
          <div className="container px-4 mx-auto">
            <div className="grid md:grid-cols-4 gap-6">
                ...
                <div className="col-span-2">
                    <div class="common_heading text-center">
                        <h2 class="font-bold mb-3">Course Advisor</h2>
                        <p>
            ...
            <Slider {...settings}>
                <div className="slider_box">
                    <div className="slider_item">
                        <div className="slider_img">
                            <img src="./images/advisor6.jpg" alt="" />
                        </div>
                        <div className="slider_content">
                            <h5 className="mb-1">James Brook</h5>
                            <p className="sub-title">Project Management Expert</p>
                            <div className="contact_social mt-2">
                                <div className="flex items-center mt-2">
                                    <a href="facebook.com" className="social-link fb">
                                    <svg
                                        aria-hidden="true"
                                        focusable="false"
                                        data-prefix="fab"
                                    ...
                                    <a href="instagram.com" className="social-link insta">
                                    <svg
                                        aria-hidden="true"
                                        focusable="false"
                                        data-prefix="fab"
                                    ...
                                    <a href="linkedin.com" className="social-link linkedin">
                                    <svg
                                        aria-hidden="true"
                                        focusable="false"
                                        data-prefix="fab"
                ...
                <div className="slider_box">
                    <div className="slider_item">
                        <div className="slider_img">
                            <img src="./images/advisor4.jpg" alt="" />
                        </div>
                        <div className="slider_content">
                            <h5 className="mb-1">James Brook</h5>
                            <p className="sub-title">Project Management Expert</p>
                ...
                <div className="slider_box">
                    <div className="slider_item">
                        <div className="slider_img">
                            <img src="./images/advisor5.jpg" alt="" />
                        </div>
                        <div className="slider_content">
                            <h5 className="mb-1">James Brook</h5>
                            <p className="sub-title">Project Management Expert</p>
